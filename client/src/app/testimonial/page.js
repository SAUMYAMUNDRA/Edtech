    ...
    <div className="min-h-screen bg-[#fcf6f1] text-gray-900">
      ...
      <section className="bg-[#fcf6f1] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center bg-gradient-to-br from-white/60 via-transparent to-white/35 rounded-3xl py-16 px-8">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Real <span className="text-yellow-500 relative">
                Stories
                <span className="absolute inset-x-0 bottom-1 h-3 bg-yellow-200/60 -z-10 rounded"></span>
              </span>, Real Outcomes
            </h1>
                  ...
                  <div key={testimonial.id} className="w-full flex-shrink-0">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                      <div className="relative w-64 h-64 mx-auto">
                        <div className="w-full h-full rounded-full overflow-hidden shadow-xl bg-gray-100">
                          <Image
                      ...
                      <div className="text-center lg:text-left">
                        ...
                        <div className="flex justify-center lg:justify-start gap-1 mb-6">
                          {[...Array(testimonial.rating)].map((_, i) => (
                            <div key={i} className="w-5 h-5 text-yellow-500">
                        ...
                        <blockquote className="text-lg text-gray-700 leading-relaxed relative">
                          <span className="text-6xl text-yellow-500/40 absolute -top-4 -left-2 font-serif">"</span>
                          {testimonial.quote}
                        </blockquote>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-6 text-center group hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredTestimonials.map((testimonial) => (
              <div key={testimonial.id} className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <blockquote className="text-gray-700 text-sm leading-relaxed relative">
                  <span className="text-4xl text-yellow-500/30 absolute -top-2 -left-1 font-serif">"</span>
                  {testimonial.quote}
                </blockquote>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button className="px-8 py-4 bg-yellow-500 text-white rounded-lg font-semibold hover:bg-yellow-400 transition-all duration-200 shadow-lg hover:shadow-xl">
                Start Your Journey
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-gradient-to-br from-white/80 to-white/40 rounded-3xl p-12 lg:p-16 text-center shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="px-10 py-4 bg-yellow-500 text-white rounded-lg font-bold text-lg hover:bg-yellow-400 transition-all duration-200 shadow-xl hover:shadow-2xl">
                Apply Now
              </button>
              <button className="px-10 py-4 border-2 border-gray-300 text-gray-700 rounded-lg font-bold text-lg hover:bg-gray-50 transition-all duration-200">
                Meet Mentors
              </button>
            </div>
          </div>
