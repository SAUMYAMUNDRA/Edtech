...
function MinimalTilt({ children, className = "" }) {
  ...
  const handleMove = e => {
    ...
    const ry = -px * 1
    setTransform(
      `perspective(1000px) rotateX(${rx}deg) rotateY(${ry}deg) scale(1.005)`
    )
  }
    ...
    <div
      ...
      style={{
        ...
        transition: transform
          ...
          : "transform 800ms cubic-bezier(.16,.84,.24,1)",
...
function ShinyButton({ children, className = "", onClick, type = "button" }) {
...
/*
IMPORTANT:
Original issue: items with multiple category values (["mentorship","career"]) appeared in both filters.
Fix: We now filter ONLY by the primary display tag (t.tag) instead of the category array.

We still keep a `categories` field if you later want multi-tag chips or search,
but the main filter compares slug(tag) to activeFilter.
*/
...
const testimonialsData = [
  ...
  },
  {
    ...
    quote:
      "Structured mock interview loops turned anxiety into a repeatable preparation system.",
    rating: 5
  },
  {
    id: 4,
...
export default function TestimonialsPage() {
  ...
  // FIXED FILTER LOGIC: Only compare primary tag
  const filteredTestimonials =
    activeFilter === "all"
      ? testimonialsData
      : testimonialsData.filter(
          t => slugify(t.tag) === activeFilter // Primary tag ONLY
        )

  // Derived scroll-based values
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#fcf6f1] text-gray-900">
        ...
        >
          {/* Floating BG */}
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at center, rgba(250,204,21,0.15), rgba(236,72,153,0.1))",
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at center, rgba(99,102,241,0.1), rgba(20,184,166,0.1))",
                ...
                <div className="space-y-8">
                  <div className="space-y-6">
                    ...
                    <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                      See how students transformed their careers through mentorship
                    ...
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-200">
                      ...
                      <div className="p-6">
                        ...
                        <blockquote className="text-gray-600 leading-relaxed">
                          "The mentorship helped me identify my strengths and build a
                          clear roadmap to my first tech role."
                        </blockquote>
                      </div>
                    </div>
                  </MinimalTilt>

                  <div className="absolute -top-4 -right-4 w-8 h-8 bg-yellow-400/10 rounded-full animate-pulse" />
                  <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-purple-400/10 rounded-full animate-bounce" />
                </div>
              </Reveal>
            </div>
          </div>
            ...
            <Reveal>
              <div className="text-center mb-16">
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                  Hear It <span className="text-yellow-500">Directly</span> From
                  Students
                </h2>
                <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                  Watch authentic video stories from students who transformed
                  their career trajectory through our mentorship programs.
                </p>
              </div>
            </Reveal>
              ...
              <Reveal delay={0.2}>
                <SimpleHover className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      "The workshops taught me how to think like a PM and
              ...
              <Reveal delay={0.3}>
                <SimpleHover className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      "I went from zero design experience to landing my dream UX
                      role in just 6 months."
                    </p>
                  </div>
                </SimpleHover>
              </Reveal>
        ...
        <section
          ref={testimonialsRef}
          className="py-20 bg-white relative z-10 scroll-mt-24"
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <Reveal>
              <div className="text-center mb-16">
                ...
                {filters.map(f => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-6 py-3 rounded-full text-sm font-semibold uppercase tracking-wide transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-yellow-500 ${
                        isActive
              ...
              {filteredTestimonials.map((t, i) => (
                <Reveal key={t.id} delay={(i % 6) * 0.07}>
                  <GentleTilt className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300 border border-gray-100">
                    <div className="flex items-center gap-4 mb-4">
                      <div
                        className={`w-14 h-14 rounded-full flex items-center justify-center text-white text-lg font-bold ${avatarColor(
                          t.name
                        )}`}
                      >
                        {getInitials(t.name)}
              ...
              <Reveal>
                <div>
                  ...
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    Watch how one learner leveraged personalized mentorship, peer
                    pods, and targeted workshops to accelerate from exploratory
                    phase to a clear technical track with tangible outcomes.
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed mb-8">
                    Every transformation begins with a candid conversation. The
            ...
            <Reveal>
              <div className="bg-gradient-to-br from-gray-50/80 to-gray-100/40 rounded-3xl p-12 lg:p-16 text-center shadow-xl">
                ...
                <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-10 leading-relaxed">
                  Join a community where guidance is actionable, feedback is
                  constructive, and growth is measurable. Your next meaningful
                  step starts here.
                </p>
